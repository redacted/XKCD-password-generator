...
A concise overview of the available ``xkcdpass`` options can be accessed via::
    ...
    Options:
        ...
        -w WORDFILE, --wordfile=WORDFILE
                                    ...
                                    ptbr-aosp-10k (Portuguese (Brazil)), swe-short (Swedish)
        --min=MIN_LENGTH
...
- Portuguese Brazil (ptbr-aosp-10k) 10k words filtered from the LatinIME(AOSP) pt-br dictionary `<https://android.googlesource.com/platform/packages/inputmethods/LatinIME/>` (Apache License, more details in the file `LICENSE-ptbr-aosp-10k.md`) using `Fabricio C Zuardi's ptbr-wordlist <https://github.com/fczuardi/ptbr-wordlist> (MIT License)`.
